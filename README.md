...
<div align="center">
  <img src="./src/image/Hummingbird.png" alt="logo" width="200"  height="auto" />
  <br/>
...
**JavaScript Capstone Project** is a website to share informations about episodes of a TV show.
...
```sh
  cd my-folder
  git clone git@github.com:Al-Amin-Khan-Shakil/JavaScript-Capstone-Project.git
```
...
```sh
  .github.io/JavaScript-Capstone-Project/
```
...
Feel free to check the [issues page](https://github.com/Al-Amin-Khan-Shakil/JavaScript-Capstone-Project/issues).
...
- **Can I contribute to this project?**
  ...
  - Yes, you can. You can fork your modification on this project. If it gets approved then we will merge your changes.

- **What knowledge Should I have to create a project like this?**

  - You should have basic HTML, CSS, and JavaScript Knowledge, and knowledge about using API, Jest and webpack.
